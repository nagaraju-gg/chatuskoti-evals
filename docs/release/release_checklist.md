...
- Lead-time summary: [`strong_v1_3_torch/lead_time/lead_time_analysis/summary.md`](../artifacts/strong_v1_3_torch/lead_time/lead_time_analysis/summary.md)
- Annotation cases: [`strong_v1_3_torch/annotation_cases.csv`](../artifacts/strong_v1_3_torch/annotation_cases.csv)
- Ablation summary: [summary.md](../artifacts/strong_v1_3_torch/ablations/summary.md)
...
- `python3 scripts/verify_release_bundle.py artifacts/strong_v1_3_torch`
- Be explicit about whether you are referencing the checked-in curated bundle or a freshly regenerated `3`-seed bundle.
- Confirm the package version and release label agree before publishing anything as `v1.3`.
- Add an annotated git tag such as `v1.3.0` once tests and curated artifacts are final.
...
- The bundle script (`scripts/run_torch_bundle.sh`) automatically stages new artifacts and replaces previously tracked ones — verify with `git status` before committing.
