...
- Cases: `4`
- Expectation matches: `0/4`
- Binary would adopt: `3` cases
- Vec3 would adopt: `3` cases
...
- Actual resolution: `adopt`
- Match: `False`
- Resolver reason: `truthness 0.762 exceeds adopt threshold 0.250`
- Expected signals: `instability_gap`
- Actual signals: `instability_gap`
- TRV: `(0.762, 0.750, 0.750)`
- Reliability components: `gap_health=-0.478, gradient_health=0.648, seed_variance=1.000`
...
- Actual resolution: `adopt`
- Match: `False`
- Resolver reason: `truthness 0.978 exceeds adopt threshold 0.250`
- Expected signals: `hyper_coherence, proxy_decoupling`
- Actual signals: `instability_gap, hyper_coherence, proxy_decoupling`
- TRV: `(0.978, 0.750, 0.750)`
- Reliability components: `gap_health=-0.513, gradient_health=1.000, seed_variance=1.000`
...
- Match: `False`
- Resolver reason: `truthness -0.981 does not exceed adopt threshold 0.250`
- Expected signals: `exploding_gradients`
- Actual signals: `exploding_gradients, loss_instability`
- TRV: `(-0.981, 0.750, 0.750)`
- Reliability components: `gap_health=0.012, gradient_health=-1.000, seed_variance=1.000`
...
- Actual resolution: `adopt`
- Match: `False`
- Resolver reason: `truthness 0.691 exceeds adopt threshold 0.250`
- Expected signals: `eval_regime_changed`
- Actual signals: `eval_regime_changed`
- TRV: `(0.691, 0.750, 0.750)`
- Reliability components: `gap_health=0.994, gradient_health=1.000, seed_variance=1.000`
