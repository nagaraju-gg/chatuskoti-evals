...
- Cases: `4`
- Expectation matches: `2/4`
- Binary would adopt: `3` cases
- Vec3 would adopt: `1` cases
...
- Actual resolution: `reframe`
- Match: `False`
- Resolver reason: `validity 0.095 is below threshold 0.150; apparent gain is not decision-ready`
- Expected signals: `exploding_gradients`
- Actual signals: `exploding_gradients, loss_instability`
- TRV: `(-0.981, 0.750, 0.095)`
